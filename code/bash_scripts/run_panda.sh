...
# Se lanza: nohup ./code/bash_scripts/run_panda.sh &

experiment_name=run_panda
...
dataset=panda-patches_512-features_resnet18
# dataset=panda-patches_512-features_resnet50
# dataset=panda-patches_512-features_vit_b_32
